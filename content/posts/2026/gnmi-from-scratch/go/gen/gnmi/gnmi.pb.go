...
import (
	gnmi_ext "github.com/sudorandom/kmcd.dev/gnmi/gen/gnmi_ext"
...
type Notification struct {
	...
	Update    []*Update              `protobuf:"bytes,4,rep,name=update,proto3" json:"update,omitempty"`        // Data elements that have been changed values.
...
// supports, and in a SubscribeRequest and GetRequest messages to specify
...
const file_gnmi_gnmi_proto_rawDesc = "" +
	...
	"\fgnmi_service\x12\x1c.google.protobuf.FileOptions\x18\xe9\a \x01(\tR\vgnmiServiceB|\xca>\x060.10.0\n" +
	"\bcom.gnmiB\tGnmiProtoP\x01Z,github.com/sudorandom/kmcd.dev/gnmi/gen/gnmi\xa2\x02\x03GXX\xaa\x02\x04Gnmi\xca\x02\x04Gnmi\xe2\x02\x10Gnmi\\GPBMetadata\xea\x02\x04Gnmib\x06proto3"
