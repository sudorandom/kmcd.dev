...
func (x *JSONEnvelope) Reset() {
	*x = JSONEnvelope{}
	mi := &file_proto_vanilla_event_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*JSONEnvelope) Descriptor() ([]byte, []int) {
	return file_proto_vanilla_event_proto_rawDescGZIP(), []int{6}
}
...
const file_proto_vanilla_event_proto_rawDesc = "" +
	...
	"\x06events\x18\x01 \x03(\v2\x1a.event_vanilla.MediumEventR\x06events\"+\n" +
	"\fJSONEnvelope\x12\x1b\n" +
	"\tjson_data\x18\x01 \x01(\tR\bjsonDataB'Z%json-vs-proto/proto/vanilla;vanillapbb\x06proto3"
...
var file_proto_vanilla_event_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_vanilla_event_proto_goTypes = []any{
	...
	(*JSONEnvelope)(nil),      // 6: event_vanilla.JSONEnvelope
...
var file_proto_vanilla_event_proto_depIdxs = []int32{
	...
	7, // 2: event_vanilla.AnyEnvelope.payload:type_name -> google.protobuf.Any
