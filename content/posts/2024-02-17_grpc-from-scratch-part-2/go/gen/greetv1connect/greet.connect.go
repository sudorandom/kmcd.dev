...
import (
	...
	context "context"
	errors "errors"
	gen "github.com/sudorandom/sudorandom.dev/content/posts/2024-02-17_grpc-from-scratch-part-2/gen"
	http "net/http"
	strings "strings"
)
...
var (
	greetServiceServiceDescriptor     = gen.File_greet_proto.Services().ByName("GreetService")
