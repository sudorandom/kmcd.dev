...
My Go script generates random shapes of different sizes, pulling from a few color palettes I like. It also randomly draws lines connecting things, because I like the "graph diagram" feel it gives. For example, here's the little chunk of code that draws a star - nothing fancy, just a bit of trigonometry to connect the dots. For this I decided to use a library called [Go Graphics (github.com/fogleman/gg)](https://github.com/fogleman/gg)
...
To transform this into something with a more more visual interest, I turned to `primitive`. It takes the source image and creates an abstract impression of it by layering simple shapes. With options to control what kinds of shapes are available, the end results are quite varied. The result is a cool, abstract vector art.
